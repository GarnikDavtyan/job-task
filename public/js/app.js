...
$('#json-form').on('submit', function (e) {
  ...
  $.ajax({
    ...
    success: function success(response) {
      $('#json-response').html("<div>ID: ".concat(response.data.id, "</div>\n          <div>Memory used by query: ").concat(response.data.query_memory_used, "B</div>\n          <div>Duration of query: ").concat(response.data.query_time, "ms</div>\n          <div>Memory used by request: ").concat(response.data.request_memory_used, "B</div>\n          <div>Duration of request: ").concat(response.data.request_time, "ms</div>"));
    },
